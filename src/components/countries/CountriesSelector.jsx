...
export const CountriesSelector = () => {
  ...
  const handleSelectCountry = ({target}) => {
    ...
    navigate(`/leagues/${target.value}`);
  }

  useEffect(() => {
    //dispatch(getCountries()); //CAMBIAR CUANDO LO QUIERA TOMAR DE VERDAD
  }, []);

  //const keys = Object.keys(countries);
  //const values = Object.values(countries);//Este es el original, mientras utilizo e otro para no hacer llamadas de mas al api
  const values = Object.values(countriesMock);
